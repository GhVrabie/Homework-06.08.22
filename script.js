...
function f6() {
    let a6Concat = a6.reduce(function(prev, curr) {
        return [...prev, ...curr];
    });
    
    for(let i = 0; i < a6Concat.length; i++) {
        document.querySelector(".out-6").innerHTML += a6Concat[i] + " ";
    }
}
...
function f9() {
    ...
    for(let i = 0; i < a9[2].length; i++) {
        return a9[2].length - 1;
    }
}
...
function f13() {
    for(let letter of a13) {
        document.querySelector(".out-13").innerHTML += letter + " ";
    }
}
...
// Пользуемся с осторожностью, так как он ищет своиства обьекта

// for(let key in arrP) {
//     console.log(arrP[key]);
// }
...
// let queryP = document.querySelectorAll("p");

// for(let i = 0; i < queryP.length; i++) {
//     console.log(queryP[i]);
// }


// Пользуемся с осторожностью, так как он ищет своиства обьекта

// for(let key in queryP) {
//     console.log(queryP[key]);
// }


// for(let value of queryP) {
//     console.log(value);
// }